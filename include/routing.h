 ...
 * @param pattern URL prefix pattern. If the pattern ends in / e.g /static/ then path /static will
 * not match. But if the pattern is /static, both /static and /static/ will match.
